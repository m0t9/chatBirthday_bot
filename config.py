...
Также для работы некоторый функций (закрепление сообщений) мне могут потребоваться права администратора.
...
/next_bd — получить следующий День рождения в этом чате
